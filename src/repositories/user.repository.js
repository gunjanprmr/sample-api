...
const database_middleware_1 = __importDefault(require("../middleware/database.middleware"));
...
let UserRepository = class UserRepository {
    ...
    getUsers() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const connect = yield mssql_1.default.connect((0, database_middleware_1.default)());
